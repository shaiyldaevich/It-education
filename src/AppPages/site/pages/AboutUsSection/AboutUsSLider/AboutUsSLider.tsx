...
const AboutUsSLider = () => {
  ...
  const cardText = [
    ...
    },
    {
      ...
      descr: "Лучшая школа в галактике и место, где я полюбил мир IT !!! Я вот-вот стану выпускником Motion Web.  За это время мне дали фундаментальные знания программирования ( C++, C#, Python ), дискретной математики, криптографии, созданию сайтов со сложной серверной архитектурой и многим другим важным навыкам. ",
      date: "23.02.2022 г",
    },
    {
      img: img1,
              ...
              {cardText.map((el, index) => (
                <div className={styles.card} key={index}>
                  ...
                  <div className={styles.text}>
                    <Typography className={styles.name}  variant="bodyXL" weight="regular">
                      {el.name}
                    </Typography>
                    <Typography
