              ...
              {data.map((item, index) => (
                <div key={index} className={scss.card}>
                  <div className={scss.info}>
                    <h1 className={scss.timeInfo}>{item.time}</h1>
                    <h1 className={scss.priceInfo}>{item.price},00 $</h1>
                    <h1 className={scss.blockInfo}>{item.payment}</h1>
                    <div className={scss.advantages}>
                      {item.advantages.map((data, index) => (
                        <h1 key={index} className={scss.advantage}>
                          ✓ {data}
                        </h1>
                      ))}
                    </div>
